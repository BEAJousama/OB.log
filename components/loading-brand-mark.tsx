...
type LoadingBrandMarkProps = {
  className?: string
  /** When false, the dashed arc does not spin (e.g. after landing). */
  spinArc?: boolean
}

/**
 * Same mark as the header brand: accent ring + optional spinning arc + accent wing.
 */
export function LoadingBrandMark({ className, spinArc = true }: LoadingBrandMarkProps) {
  return (
    <svg
    ...
    >
      ...
      />
      <g
        className={spinArc ? "loading-logo-arc" : undefined}
